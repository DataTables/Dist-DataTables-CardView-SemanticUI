# CardView for DataTables with styling for [SemanticUI](https://semantic-ui.com/)

This is the distribution package for the [CardView extension](https://datatables.net/extensions/cardview) for [DataTables](https://datatables.net/) with styling for [SemanticUI](https://semantic-ui.com/).
...
npm install datatables.net-cardview-se
```
...
import 'datatables.net-cardview-se'
